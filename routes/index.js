...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Utilities App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Utilities App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Utilities App Login', user : req.user }); 
}); 
